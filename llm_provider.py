...
def _base_config_kwargs() -> dict[str, Any]:
    """Return generation defaults shared by every Gemini call path."""
...
def _generate(
    ...
    *,
    ...
    """Generate through one retry/fallback policy for all Gemini call types."""
    from google.genai import types
...
def generate_with_tools(
    *,
    ...
    response, _ = _generate(contents, config_kwargs=config_kwargs)
    return response


class GeminiProvider:
    """Small dependency-injection wrapper around the shared Gemini policy."""
