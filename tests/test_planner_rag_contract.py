...
def test_knowledge_plan_has_one_required_logical_rag_capability():
    ...
    assert required_steps[0]["preferred_tools"] == ("search_weather", "ask_weather")
    assert required_steps[0]["parallelizable"] is False
